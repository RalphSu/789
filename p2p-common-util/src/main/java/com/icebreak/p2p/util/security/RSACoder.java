...
public abstract class RSACoder extends Coder {
	...
	private static final String RSA_PUBKEY_FILENAME = "";
	private static final String RSA_PRIKEY_FILENAME = "";
	...
	static {
		publicKeyFile = new File(getRSAPairFilePath(RSA_PUBKEY_FILENAME));
		privateKeyFile = new File(getRSAPairFilePath(RSA_PRIKEY_FILENAME));
    }
    ...
    private static void saveKeyPair(Object rsakey, String type) {
        ...
        try {
        	if("public".equals(type)){
        		 fos = FileUtils.openOutputStream(publicKeyFile);
        	}else{
        		fos = FileUtils.openOutputStream(privateKeyFile);
        	}
    ...
    private static Object readKeyPair(String type) {
        ...
        try {
        	if("public".equals(type)){
        		fis = FileUtils.openInputStream(publicKeyFile);
        		ois = new ObjectInputStream(fis);
        		publicKey = (RSAPublicKey) ois.readObject();
                return publicKey;
        	}else{
        		fis = FileUtils.openInputStream(privateKeyFile);
        		ois = new ObjectInputStream(fis);
