...
public class AuthorityController {
	...
	public Object getGrantablePermissionsByRoleId(@PathVariable int roleId, @PathVariable int page,
													@PathVariable int size, Model model) {
		/*model.addAttribute("page",
			authorityService.getGrantablePermissionsByRoleId(roleId, (page - 1) * size, size));
		return authorityService.getGrantablePermissionsByRoleId(roleId, (page - 1) * size, size);*/
	...
	public String grantPermissionsToRole(@PathVariable int roleId, int[] permissionIds) {
		...
		authorityService.replacePermisssionsToRole(roleId, permissionIds);
		return "";
	}
