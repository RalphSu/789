 ...
 * @method
   ...
   floatNum： 
   ip：验证IP地址
   customRmote： 添加customSuccess和customError回调函数
   mustNo：不能输入...
   mustNotInclude:不包含,
   mustYes：必须输入...
   notAllNum:
...
if (jQuery.validator) {
	...
	jQuery.validator.addMethod('mobileOrEmail', function(value, element, param) {       
		var phone = /^((((13[0-9]{1})|(15[0-9]{1})|(17[0-9]{1})|(18[0-9]{1})|(14[0-9]{1}))+\d{8}))|(((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@[a-z0-9_-]{2,}(\.[a-z0-9_-]{2,})*\.(com|org|net|mil|edu)(\.cn)?)$/;
	...
	jQuery.validator.addMethod('isPhoneOrMobile', function(value, element, param) {       
		var phone = /^(((13[0-9]{1})|(15[0-9]{1})|(17[0-9]{1})|(18[0-9]{1})|(14[0-9]{1}))+\d{8})|(0\d{2,4}-?\d{8})$/;
		return this.optional(element) || phone.test(value);       
	}, $.validator.format("请输入{0}"));
